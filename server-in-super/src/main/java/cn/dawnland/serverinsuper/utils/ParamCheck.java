package cn.dawnland.serverinsuper.utils;
...
public class ParamCheck {
    ...
    public static final String MIN_OUT = "id不能小于等于0";
    ...
    public static void idCheck(String key, Long id) throws Exception{
        if(id < 0){
            throw new Exception("key:" + key + MIN_OUT);
        }
    }
}
